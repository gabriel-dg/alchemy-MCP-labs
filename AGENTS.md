...
- Use only tool names that exist on the server. Do not invent tools. There is no `resolveEnsName`; resolve ENS with `web3Sha3` plus `ethCall` as described in the skill.
